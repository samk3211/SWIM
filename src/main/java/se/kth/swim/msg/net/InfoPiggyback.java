...
public class InfoPiggyback implements Serializable {
    ...
    private NatedAddress infoParent;
    ...
    */
    ...
    public InfoPiggyback(InfoType t, NatedAddress n, NatedAddress np) {
        this.infoType = t;
        this.infoTarget = n;
        this.infoParent = np;
    }
     ...
     */
    public NatedAddress getInfoParent() {
        return infoParent;
    }
     ...
     */
    public void setInfoParent(NatedAddress newParent) {
        this.infoParent = newParent;
    }
